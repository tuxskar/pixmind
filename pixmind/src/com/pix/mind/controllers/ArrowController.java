...
public class ArrowController extends PixGuyController{
	...
	public ArrowController(PixGuy pixGuy, Stage stage) {
		super(pixGuy);
		this.stage = stage;  
		Image leftArrow = new Image(new Texture(Gdx.files.internal("data/textures/OneBlackPixel.png")));
		Image rightArrow = new Image(new Texture(Gdx.files.internal("data/textures/OneBlackPixel.png")));
//		Image rightArrow = leftArrow;
//		rightArrow.rotate(180);
//		leftArrow.setPosition(leftArrow.getImageWidth()/10, leftArrow.getHeight()/10);
		float arrowWidth = 30;
		...
		rightArrow.setPosition(stage.getWidth()-arrowWidth-arrowWidth/10, arrowHeight/10);
