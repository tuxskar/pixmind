...
public class Level19 extends PixMindLevel {
	...
	public void show() {
		super.show();
		super.setNextLevel(game.getLevel20());
		...
		// Creating All STATIC PLATFORMS
			...
			// Box2D platforms
				...
				StaticPlatform sP11 = new StaticPlatform(box2D.getWorld(), -0.1f, 
						2.4f, 0.7f, 0.1f);
		...
		// Creating All ACTIVATORS
			...
			// Box2D Activator
				...
				PlatformActivator pA11 = new PlatformActivator(box2D.getWorld(), 0.8f,
						7.5f, 0.2f);
